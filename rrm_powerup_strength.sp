...
TFCond cond = TFCond_RuneStrength;

int gEnabled = 0;

public Plugin myinfo = {
    name= "[RRM] Strength Powerup Modifier",
    author = "Katsute",
    description = "Modifier that grants strength powerup.",
    version = "1.0"
};
...
void RegisterModifiers(){
    RRM_Register("Strength Powerup", 0.0, 0.0, false, RRM_Callback_Powerup);
}
