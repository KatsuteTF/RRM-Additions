...
{
    cMin = CreateConVar("rrm_shoot_fireball_min", "0.01", "Minimum value for the random number generator.");
    cMax = CreateConVar("rrm_shoot_fireball_max", "0.1", "Maximum value for the random number generator.");
