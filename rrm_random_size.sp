...
{
    cMin = CreateConVar("rrm_random_size_min", "0.25", "Minimum value for the random number generator.");
    cMax = CreateConVar("rrm_random_size_max", "2.0",  "Maximum value for the random number generator.");
    ...
    AutoExecConfig(true, "rrm_random_size", "rrm");
}
...
{
    RRM_Register("Random Size", gMin, gMax, false, RRM_Callback_RandomSize);
}
