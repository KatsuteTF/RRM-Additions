...
public Plugin myinfo = {
    name = "[RRM] Bullet Spread Modifier",
    author = "Katsute",
    description = "Modifier that modifies bullet spread.",
    version = "1.0"
};

public void OnPluginStart(){
    cMin = CreateConVar("rrm_attribute_spread_min", "0.1", "Minimum value for the random number generator.");
    cMax = CreateConVar("rrm_attribute_spread_max", "3.0", "Maximum value for the random number generator.");
    cDelay = CreateConVar("rrm_attribute_spread_delay", "1.2", "Delay to apply attribute.");
    ...
    AutoExecConfig(true, "rrm_attribute_spread", "rrm");
}
...
void RegisterModifiers(){
    RRM_Register("Bullet Spread", gMin, gMax, false, RRM_Callback_Attribute);
}
