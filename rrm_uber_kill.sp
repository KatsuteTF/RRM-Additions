...
{
    cMin      = CreateConVar("rrm_uber_kill_min",      "0.1", "Minimum value for the random number generator.");
    cMax      = CreateConVar("rrm_uber_kill_max",      "1.0", "Maximum value for the random number generator.");
    cDuration = CreateConVar("rrm_uber_kill_duration", "5.0", "Duration for uber after kill.");
    ...
    AutoExecConfig(true, "rrm_uber_kill", "rrm");
...
{
    RRM_Register("Uber Kill", gMin, gMax, false, RRM_Callback_UberKill);
}
