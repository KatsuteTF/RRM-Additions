...
|`rrm_headless_horsemann_max`|`0.1`|Max Headless Horsemann chance|
|`rrm_headless_horsemann_health`|`1000`|Headless Horsemann health|
...
|`rrm_monoculus_max`|`0.1`|Max Monoculus chance|
