...
{
    cMin = CreateConVar("rrm_shoot_grenade_min", "0.05", "Minimum value for the random number generator.");
    cMax = CreateConVar("rrm_shoot_grenade_max", "0.2", "Maximum value for the random number generator.");
