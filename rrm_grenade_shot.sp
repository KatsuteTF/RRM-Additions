...
{
    cMin = CreateConVar("rrm_grenade_shot_min", "0.1", "Minimum value for the random number generator.");
    cMax = CreateConVar("rrm_grenade_shot_max", "1.0", "Maximum value for the random number generator.");
    ...
    AutoExecConfig(true, "rrm_grenade_shot", "rrm");
...
void SpawnGrenade(int client)
{
    ...
    SetEntPropEnt(pipe, Prop_Send, "m_hOwnerEntity", client);
    SetEntProp(pipe, Prop_Send, "m_iTeamNum", GetClientTeam(client));
